  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg mt-10">
        ...
        <section className="mb-8">
            ...
            <div className="mb-6">
                <p className="text-lg font-bold">Software Developer | [Company Name]</p>
            ...
            <div className="mb-6">
                <p className="text-lg font-bold">Software Engineering Intern | [Company Name]</p>
                <p className="text-sm text-gray-600">Jun 2020 - Aug 2020</p>
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700">
                    <li>Assisted in the development of a full-stack web application using Python and Flask, resulting in a 20% increase in user engagement.</li>
                    <li>Wrote unit and integration tests, achieving 90% code coverage and reducing bugs in production.</li>
                    <li>Implemented an agile project management system, contributing to the successful delivery of the project within the deadline.</li>
                    <li>Participated in daily stand-ups, sprint planning, and retrospectives, gaining experience in agile methodologies.</li>
                </ul>
            </div>
